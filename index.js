...
// ACTION
const addContactInfo = ({name = '', email = '', phone = '', company = ''} = {}) => ({
...
const validateForm = (selectedTab) => (values) => {
    ...
    if (selectedTab === 0) {
        ...
        } else if (!values.phone.trim().match(/^08\d{2,}$/)) {
            ...
            <div className="form-container">
                ...
                <div className="form-group">
                    ...
                    <div className={errors.phone ? 'form-input-error' : 'form-input'}>
                        <input type="text" id="phone" placeholder="Phone number" name="phone" maxLength={14} onKeyPress={typing} value={values.phone} onChange={onChange} onBlur={onBlur}/>
    ...
    return (
        <div className="card-container">
            ...
            <div className="form-container-box">
                <label htmlFor="budget1" className='budget'>
                    <input id="budget1" name="budget" type="radio" value="5000 - 10000" checked={values.budget === "5000 - 10000"} onChange={onChange}/>
                ...
                <label htmlFor="budget2" className='budget'>
                    <input id="budget2" name="budget" type="radio" value="10000 - 20000" checked={values.budget === "10000 - 20000"} onChange={onChange}/>
                    <div htmlFor="services" id="service-box" className="form-budget">
                        <div class="checkmark">
                        </div>
                        <div class="checkmark-dot"></div>
                ...
                <label htmlFor="budget3" className='budget'>
                    <input id="budget3" name="budget" type="radio" value="20000 - 50000" checked={values.budget === "20000 - 50000"} onChange={onChange}/>
...
const Services = ({ values, onChange }) => {
    return(
        <div className="card-container">
            <div className="header-form">
                <p className="title-form">Our services</p>
                <p className="subtitle-form">Please select which service you are interested in.</p>
            </div>
            <form action="">
            <div className="form-container-box">
                <label htmlFor="service">
                    <input id="development" name="service" type="radio" value="Development" checked={values.service === "Development"} onChange={onChange}/>
                    <div htmlFor="services" id="service-box" className="form-services">
                        ...
                        <p className="options-label">Development</p>
                    </div>
                </label>
                <label htmlFor="service">
                    <input id="webdesign" name="service" type="radio" value="Web Design" checked={values.service === "Web Design"} onChange={onChange}/>
                    <div id="service-box" className="form-services">
                        <div className="icon-wrap">
                                <div className="icon">
                                </div>
                        ...
                        <p className="options-label">Web Design</p>
                    </div>
                </label>
                <label htmlFor="service">
                    <input id="marketing" name="service" type="radio" value="Marketing" checked={values.service === "Marketing"} onChange={onChange}/>
                    <div id="service-box" className="form-services">
                        <div className="icon-wrap">
                                <div className="icon">
                                </div>
                        ...
                        <p className="options-label">Marketing</p>
                    </div>
                </label>
                <label htmlFor="service">
                    <input id="other" name="service" type="radio" value="Other" checked={values.service === "Other"} onChange={onChange}/>
                    <div id="service-box" className="form-services">
                        <div className="icon-wrap">
                                <div className="icon">
                                </div>
                        ...
                        <p className="options-label">Other</p>
                    </div>
                </label>
            </div>
            </form>
